export default function projectArr () { return(
  [
  {
    title: 'Food Saver',
    href: 'https://github.com/Spikeophant/foodsaver',
  ...
  },
  {
    ...
    href: 'https://github.com/Spikeophant/readme-robot',
    content: 'A simple README.md generator, it just generates a pretty simple README.md currently but will continue to ' +
      'make improvements.  Have considered combinging with JATE to make a quick little GUI README.md generator.  Likely' +
      'better to spend my time in IntelliJ and leave this as an exercise for a bootcamp.'
  },
  {
    title: 'DnD Char Folio',
    href: 'https://github.com/Spikeophant/dndCharFolio',
    content: 'A group project, supposed to be 3 or more of us, ended up pretty much 2 of us due to an injury and a no show.' +
